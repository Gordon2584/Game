...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String getPlayerOneName = getIntent().getStringExtra("Первый игрок");
        final String getPlayerTwoName = getIntent().getStringExtra("Второй игрок");
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition){
        ...
        if (playerTurn == 1){
            ...
            if (checkPlayerWin()){
                ...
                WinDialog winDialog = new WinDialog(MainActivity.this, playerOneName.getText().toString() + " выйграл матч", MainActivity.this);
            ...
            if (checkPlayerWin()){
                ...
                WinDialog winDialog = new WinDialog(MainActivity.this, playerTwoName.getText().toString() + " выйграл матч", MainActivity.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
